...
<html lang="en"><head>
    ...
    <meta name="description" content="Presentation of SmartShare, an Outlook addin for improved file sharing.">
    <meta name="author" content="Wagapi">
	<meta NAME="keywords" content="outlook,addin,plugin,large,file,document,picture,video,share,send,free,tool,wagapi">
...
<div class="jumbotron subhead">
  <div class="container">
	<div class="row">
		<div class="span7">
			<h1>Smartsha.re</h1>
			<p>A smart service to send gigabytes of documents with Outlook !</p>		
		</div>
		<div class="span4 offset1" style="margin-top:40px">
			<a href="https://www.wagapi.com/pub/smartshare/last/setup.exe" class="btn btn-primary btn-large" >Click here to download and install the free version !</a>
		</div>
		<!-- Navbar
		<div class="span5" >
    ...
    <ul class="masthead-links">
	  ...
	  <li>
	  Available now for Microsoft &#174; Outlook 2007/2010/2013
	  </li>
    </ul>
  </div>
</div>
			 ...
			 <div class="media" style="padding-top:20px;"></div>
					<div class="media">
									...
									<div class="media-body">
										<h2>Exchange large documents faster through your messaging system !</h2>
					...
					<div class="row">
						...
						<div class="span8 offset2">
							<table class="table table-bordered" >
								...
								<tbody>
									<tr><td colspan="3"><h4>Features</h4></td>
									</tr>									
									<tr>
										<td >
									...
									<tr><td colspan="3"><h4>What you save</h4></td>
									</tr>
									<tr>
										<td >
											Time
									...
									<tr><td colspan="3"><h4>Support & Guarantees</h4></td>
									</tr>
									<tr>									
										<td >
											SLA
									...
									<tr>		
										...
										<td style="text-align:center">
											<a href="http://www.wagapi.com/pub/smartshare/SmartShareforMSO2010.zip" class="btn btn-success"> Try SmartSha.re Free !</a>
										</td>
										<td style="text-align:center">
											<a  href="http://wagapi.zendesk.com/account/dropboxes/20133173" onClick="script: Zenbox.show();" class="btn btn-success"> Interested in SmartSha.re Pro ? Contact us</a>
										</td>																				
									</tr>										
								</tbody>
						...
						<div class="span12">
							<p>
								<div class="row">	
									<div class="span12">
									<a href="http://wagapi.zendesk.com/account/dropboxes/20133173" onClick="script: Zenbox.show();" class="btn btn-primary btn-large contact" >Get in touch with us !</a>
									</div>
								</div>	
							</p>		
						</div>						
